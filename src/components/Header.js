    ...
    return (
        <header className="header bg-primary flex flex-align-center">
            <div className="container flex">
                <select value={sortBy} id="sortBy" className="form-field fs-400" name="sortBy" placefolder="" onChange={handleSortBy}>
                    <option value="default">Sort the result</option>
